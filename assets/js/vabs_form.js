...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_vabswrapper_js__ = __webpack_require__(2);

new __WEBPACK_IMPORTED_MODULE_0__components_vabswrapper_js__["a" /* default */](document.querySelectorAll('.vabs-api-form'), vabs_obj.ajax_url + 'handler.php', vabs_obj.lang);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bookingwrapper_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contactwrapper_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__node_modules_flatpickr_dist_plugins_rangePlugin_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__node_modules_flatpickr_dist_plugins_rangePlugin_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__node_modules_flatpickr_dist_plugins_rangePlugin_js__);
...
var VabsWrapper = function () {
	function VabsWrapper(elements, url) {
		var lang = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

		_classCallCheck(this, VabsWrapper);
	...
	_createClass(VabsWrapper, [{
		key: 'init',
		value: function init(selectors) {
			var _this = this;

			selectors.forEach(function (elem, index) {
				if (elem.dataset.form === 'booking') {
					_this.forms[index] = new __WEBPACK_IMPORTED_MODULE_1__bookingwrapper_js__["a" /* default */](_this.url, _this.lang[elem.dataset.lang]);
					_this.createBookingForm(elem, _this.forms[index], elem.dataset.lang);
				}

				if (elem.dataset.form === 'contact') {
					_this.forms[index] = new __WEBPACK_IMPORTED_MODULE_2__contactwrapper_js__["a" /* default */](_this.url, _this.lang[elem.dataset.lang]);
					_this.createContactForm(elem, _this.forms[index], elem.dataset.lang);
				}
			});
		}
	}, {
		key: 'createContactForm',
		value: function createContactForm(elem, wrapper, lang) {

			/**
    * create formwrapper
    */
			var s = this.lang[lang]['button_contact'] ? this.lang[lang]['button_contact'] : 'Formular absenden';
			var formwrapper = this.formWrapper(wrapper, s);
    ...
    */
		...
		value: function createBookingForm(elem, wrapper, lang) {

			/**
    * create formwrapper
    */
			var s = this.lang[lang]['button_next'] ? this.lang[lang]['button_next'] : 'weiter';
			var formwrapper = this.formWrapper(wrapper, s);

			/**
    * create list of courses
    */
			var formList = this.bookingFormList(lang);
    ...
    */
			formwrapper.querySelectorAll('.confirmation .link').forEach(function (link) {
				link.addEventListener('click', function (e) {
					var cl = e.target.dataset.target;
					var el = '.vabsform__body--element.' + cl + ' .element__body';

					formwrapper.querySelectorAll('.element__body').forEach(function (element) {
   ...
   */
		...
		key: 'formWrapper',
		value: function formWrapper(wrapper, string) {
			var form = document.createElement('form');
			form.className = 'vabsform';
			form.autocomplete = 'off';
			var html = '<div class="vabsform__body"></div>';
			...
			form.querySelector('button.vabsformsubmit').addEventListener('click', function (e) {
				e.preventDefault();
		...
		key: 'flatPickr',
		value: function flatPickr(elem) {
			var anreiseElem = elem.querySelector('input[name="anreise"]');
			var abreiseElem = elem.querySelector('input[name="abreise"]');
			if (window.innerWidth > 767) {
				flatpickr(anreiseElem, {
					...
					dateFormat: "Y-m-d",
					altFormat: "d.m.Y",
					plugins: [new __WEBPACK_IMPORTED_MODULE_3__node_modules_flatpickr_dist_plugins_rangePlugin_js___default.a({ input: abreiseElem })]
				});
   ...
   */
		...
		key: 'bookingFormList',
		value: function bookingFormList(lang) {
   ...
   */
		...
		key: 'appendListItems',
		value: function appendListItems(element, el, wrapper) {
			var _this2 = this;
     ...
     */
				...
				var group = this.fetchData('get_courses_of_group', { id: el.dataset.query });

				group.then(function (items) {
					items.forEach(function (item) {
						_this2.listItem(wrapper, element, item);
     ...
     * @type {*|Array}
     */
				var ids = el.dataset.query.split(',');

				var courses = this.asyncFetchMultipleCoursesById(ids);
				...
				courses.then(function (response) {
					for (var i = 0; i < response.length; i++) {
						...
						_this2.listItem(wrapper, element, course);
   ...
   */
		...
		key: 'appendInterest',
		value: function appendInterest(form) {
			var interests = this.fetchData('get_client_interest');

			interests.then(function (response) {
   ...
   */
		...
		key: 'listItem',
		value: function listItem(wrapper, elem, item) {

			var priceData = this.fetchData('get_course_details', { id: item.id, qty: item.minBookableAmount });
     ...
     */
				...
				div.querySelector('input[name="courseqty"]').addEventListener('change', function (e) {
   ...
   */
		...
		key: 'userform',
		value: function userform(wrapper, lang) {
			...
			div.querySelector('select[name="interest"]').addEventListener('change', function (e) {
				e.preventDefault();
			...
			div.querySelectorAll('input[type="text"]').forEach(function (input) {
   ...
   */
		...
		key: 'formConfirmation',
		value: function formConfirmation(lang) {
			var div = document.createElement('div');
			div.className = 'vabsform__body--element';
   ...
   */
		...
		key: 'fetchData',
		value: function fetchData(method) {
		...
		key: 'asyncFetchMultipleCoursesById',
		value: function () {
			var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(ids) {
				var method, array, i, id, response, data, sorted;
				return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								method = 'get_single_course';
								array = [];
								i = 0;
							...
							case 15:
								sorted = array.slice(0).sort(function (a, b) {
			...
			function asyncFetchMultipleCoursesById(_x4) {
				return _ref.apply(this, arguments);
			}

			return asyncFetchMultipleCoursesById;
		}()
	}]);
...
/* harmony default export */ __webpack_exports__["a"] = (VabsWrapper);
...
var BookingWrapper = function () {
	function BookingWrapper(url, lang) {
		_classCallCheck(this, BookingWrapper);
  ...
  */
   ...
   */
		...
		key: 'addPrice',
		value: function addPrice(course, data) {
   ...
   */
		...
		key: 'updateCourseQty',
		value: function updateCourseQty(e) {
			var _this = this;
			...
			var output = e.target.parentElement.parentElement.querySelector('.course__price');
			fetch(this.url + '?method=get_course_details', {
				...
				_this.selectedCourses[e.target.dataset.course].price = priceObject;
				_this.selectedCourses[e.target.dataset.course].qty = e.target.value;
			});
		}
   ...
   */
		...
		value: function updateCourseList(e) {
			if (e.target.checked) {
   ...
   */
		...
		key: 'humanReadableDate',
		value: function humanReadableDate(date) {
   ...
   */
		...
		value: function showConfirmation(form) {
			...
			form.querySelectorAll('.confirmation__course div').forEach(function (div) {
				div.remove();
			});
			var total = 0;
			for (var key in this.selectedCourses) {
				var course = this.selectedCourses[key];
				var p = parseFloat(course.price.price);
				total += p;
				var div = document.createElement('div');
   ...
   */
     ...
     */
      ...
      */
					if (obj.lead_id) {
						return fetch(_this2.url + '?method=add_sales_order', {
							method: 'POST',
							body: JSON.stringify({
								contact_id: obj.contact_id,
								shorttext: _this2.user.interest ? 'Interesse: ' + _this2.user.interest : 'Frontendbuchung'
							})
						}).then(function (response) {
							return response.json();
						});
      ...
      */
					var sales_header_id = response.sales_header_id;
					var salesOrder = [];

					for (var key in _this2.selectedCourses) {
						var course = _this2.selectedCourses[key];
						salesOrder.push(fetch(_this2.url + '?method=add_sales_line', {
							method: 'POST',
							body: JSON.stringify({
								sales_header_id: sales_header_id,
								object_id: course.id,
								quantity: course.qty,
								date_from: _this2.user.anreise,
								date_to: _this2.user.abreise
							})
						}).then(function (response) {
							return response.json();
						}));
					...
					if (salesOrder.length === Object.keys(_this2.selectedCourses).length) {
						return salesOrder;
					}
   ...
   */
		...
		value: function reset(form) {
			...
			setTimeout(function () {
				form.reset();
				form.querySelectorAll('.confirmation .link').forEach(function (link) {
					link.remove();
				});
				...
				_this3.selectedCourses = {};
				_this3.current = 'course';
...
/* harmony default export */ __webpack_exports__["a"] = (BookingWrapper);
...
var ContactWrapper = function () {
	function ContactWrapper(url, lang) {
		_classCallCheck(this, ContactWrapper);
  ...
  */
   ...
   */
		...
		key: 'submit',
		value: function submit(e, form, lang) {
			if (this.validation()) {
   ...
   */
		...
		key: 'submitForm',
		value: function submitForm(form, lang) {
			var _this = this;
   ...
   */
		...
		value: function reset(form) {
			...
			setTimeout(function () {
				...
				_this2.selectedCourses = {};
				_this2.current = 'course';
...
/* harmony default export */ __webpack_exports__["a"] = (ContactWrapper);
