...
var form = $('#vabs_persdata input, #vabs_persdata textarea');
var button = document.querySelector('.vabs__button');
var url = vabs_obj.ajax_url + 'handler.php';

/**
 *
 * @type string = Title of Cart
 */
var step = 'vabs__course--selector';
...
function init() {
	...
	var response = ApiCall(document.getElementById('vabs-form-type').name, data);
...
$('input[name="course"]').on('change', function () {
	...
	var priceObj = ApiCall('get_course_details', data);
...
function submitForm() {
	...
	var contact = ApiCall('create_new_contact', user);
	...
	var lead = ApiCall('create_new_lead', LeadData);
	...
	var salesOrder = ApiCall('add_sales_order', salesOrderData);
	...
	var salesLine = ApiCall('add_sales_line', salesLineData);
